...
bindgen jvmti.h -o src/sys.rs --use-core --raw-line "use jni_sys::*;"
 ...
 --whitelist-var "JVMTI.*" --blacklist-type "JNI.*" --blacklist-type "jni.*"
 */
...
pub const JVMTI_THREAD_STATE_ALIVE: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_ALIVE;
pub const JVMTI_THREAD_STATE_TERMINATED: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_TERMINATED;
pub const JVMTI_THREAD_STATE_RUNNABLE: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_RUNNABLE;
pub const JVMTI_THREAD_STATE_BLOCKED_ON_MONITOR_ENTER: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_BLOCKED_ON_MONITOR_ENTER;
pub const JVMTI_THREAD_STATE_WAITING: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_WAITING;
pub const JVMTI_THREAD_STATE_WAITING_INDEFINITELY: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_WAITING_INDEFINITELY;
pub const JVMTI_THREAD_STATE_WAITING_WITH_TIMEOUT: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_WAITING_WITH_TIMEOUT;
pub const JVMTI_THREAD_STATE_SLEEPING: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_SLEEPING;
pub const JVMTI_THREAD_STATE_IN_OBJECT_WAIT: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_IN_OBJECT_WAIT;
pub const JVMTI_THREAD_STATE_PARKED: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_PARKED;
pub const JVMTI_THREAD_STATE_SUSPENDED: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_SUSPENDED;
pub const JVMTI_THREAD_STATE_INTERRUPTED: _bindgen_ty_2 =
    _bindgen_ty_2::JVMTI_THREAD_STATE_INTERRUPTED;
pub const JVMTI_THREAD_STATE_IN_NATIVE: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_IN_NATIVE;
pub const JVMTI_THREAD_STATE_VENDOR_1: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_VENDOR_1;
pub const JVMTI_THREAD_STATE_VENDOR_2: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_VENDOR_2;
pub const JVMTI_THREAD_STATE_VENDOR_3: _bindgen_ty_2 = _bindgen_ty_2::JVMTI_THREAD_STATE_VENDOR_3;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_2 {
    JVMTI_THREAD_STATE_ALIVE = 1,
    JVMTI_THREAD_STATE_TERMINATED = 2,
    JVMTI_THREAD_STATE_RUNNABLE = 4,
    JVMTI_THREAD_STATE_BLOCKED_ON_MONITOR_ENTER = 1024,
    JVMTI_THREAD_STATE_WAITING = 128,
    JVMTI_THREAD_STATE_WAITING_INDEFINITELY = 16,
    JVMTI_THREAD_STATE_WAITING_WITH_TIMEOUT = 32,
    JVMTI_THREAD_STATE_SLEEPING = 64,
    JVMTI_THREAD_STATE_IN_OBJECT_WAIT = 256,
    JVMTI_THREAD_STATE_PARKED = 512,
    JVMTI_THREAD_STATE_SUSPENDED = 1048576,
    JVMTI_THREAD_STATE_INTERRUPTED = 2097152,
    JVMTI_THREAD_STATE_IN_NATIVE = 4194304,
    JVMTI_THREAD_STATE_VENDOR_1 = 268435456,
    JVMTI_THREAD_STATE_VENDOR_2 = 536870912,
    JVMTI_THREAD_STATE_VENDOR_3 = 1073741824,
}
...
pub const JVMTI_HEAP_FILTER_TAGGED: _bindgen_ty_5 = _bindgen_ty_5::JVMTI_HEAP_FILTER_TAGGED;
pub const JVMTI_HEAP_FILTER_UNTAGGED: _bindgen_ty_5 = _bindgen_ty_5::JVMTI_HEAP_FILTER_UNTAGGED;
pub const JVMTI_HEAP_FILTER_CLASS_TAGGED: _bindgen_ty_5 =
    _bindgen_ty_5::JVMTI_HEAP_FILTER_CLASS_TAGGED;
pub const JVMTI_HEAP_FILTER_CLASS_UNTAGGED: _bindgen_ty_5 =
    _bindgen_ty_5::JVMTI_HEAP_FILTER_CLASS_UNTAGGED;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_5 {
    JVMTI_HEAP_FILTER_TAGGED = 4,
    JVMTI_HEAP_FILTER_UNTAGGED = 8,
    JVMTI_HEAP_FILTER_CLASS_TAGGED = 16,
    JVMTI_HEAP_FILTER_CLASS_UNTAGGED = 32,
}
pub const JVMTI_VISIT_OBJECTS: _bindgen_ty_6 = _bindgen_ty_6::JVMTI_VISIT_OBJECTS;
pub const JVMTI_VISIT_ABORT: _bindgen_ty_6 = _bindgen_ty_6::JVMTI_VISIT_ABORT;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_6 {
    JVMTI_VISIT_OBJECTS = 256,
    JVMTI_VISIT_ABORT = 32768,
}
pub const JVMTI_CLASS_STATUS_VERIFIED: _bindgen_ty_7 = _bindgen_ty_7::JVMTI_CLASS_STATUS_VERIFIED;
pub const JVMTI_CLASS_STATUS_PREPARED: _bindgen_ty_7 = _bindgen_ty_7::JVMTI_CLASS_STATUS_PREPARED;
pub const JVMTI_CLASS_STATUS_INITIALIZED: _bindgen_ty_7 =
    _bindgen_ty_7::JVMTI_CLASS_STATUS_INITIALIZED;
pub const JVMTI_CLASS_STATUS_ERROR: _bindgen_ty_7 = _bindgen_ty_7::JVMTI_CLASS_STATUS_ERROR;
pub const JVMTI_CLASS_STATUS_ARRAY: _bindgen_ty_7 = _bindgen_ty_7::JVMTI_CLASS_STATUS_ARRAY;
pub const JVMTI_CLASS_STATUS_PRIMITIVE: _bindgen_ty_7 = _bindgen_ty_7::JVMTI_CLASS_STATUS_PRIMITIVE;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub const JVMTI_VERSION_INTERFACE_JNI: _bindgen_ty_8 = _bindgen_ty_8::JVMTI_VERSION_INTERFACE_JNI;
pub const JVMTI_VERSION_INTERFACE_JVMTI: _bindgen_ty_8 =
    _bindgen_ty_8::JVMTI_VERSION_INTERFACE_JVMTI;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_8 {
    JVMTI_VERSION_INTERFACE_JNI = 0,
    JVMTI_VERSION_INTERFACE_JVMTI = 805306368,
}
pub const JVMTI_VERSION_MASK_INTERFACE_TYPE: _bindgen_ty_9 =
    _bindgen_ty_9::JVMTI_VERSION_MASK_INTERFACE_TYPE;
pub const JVMTI_VERSION_MASK_MAJOR: _bindgen_ty_9 = _bindgen_ty_9::JVMTI_VERSION_MASK_MAJOR;
pub const JVMTI_VERSION_MASK_MINOR: _bindgen_ty_9 = _bindgen_ty_9::JVMTI_VERSION_MASK_MINOR;
pub const JVMTI_VERSION_MASK_MICRO: _bindgen_ty_9 = _bindgen_ty_9::JVMTI_VERSION_MASK_MICRO;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_9 {
    JVMTI_VERSION_MASK_INTERFACE_TYPE = 1879048192,
    JVMTI_VERSION_MASK_MAJOR = 268369920,
    JVMTI_VERSION_MASK_MINOR = 65280,
    JVMTI_VERSION_MASK_MICRO = 255,
}
pub const JVMTI_VERSION_SHIFT_MAJOR: _bindgen_ty_10 = _bindgen_ty_10::JVMTI_VERSION_SHIFT_MAJOR;
pub const JVMTI_VERSION_SHIFT_MINOR: _bindgen_ty_10 = _bindgen_ty_10::JVMTI_VERSION_SHIFT_MINOR;
pub const JVMTI_VERSION_SHIFT_MICRO: _bindgen_ty_10 = _bindgen_ty_10::JVMTI_VERSION_SHIFT_MICRO;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub const JVMTI_RESOURCE_EXHAUSTED_OOM_ERROR: _bindgen_ty_11 =
    _bindgen_ty_11::JVMTI_RESOURCE_EXHAUSTED_OOM_ERROR;
pub const JVMTI_RESOURCE_EXHAUSTED_JAVA_HEAP: _bindgen_ty_11 =
    _bindgen_ty_11::JVMTI_RESOURCE_EXHAUSTED_JAVA_HEAP;
pub const JVMTI_RESOURCE_EXHAUSTED_THREADS: _bindgen_ty_11 =
    _bindgen_ty_11::JVMTI_RESOURCE_EXHAUSTED_THREADS;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum _bindgen_ty_11 {
    JVMTI_RESOURCE_EXHAUSTED_OOM_ERROR = 1,
    JVMTI_RESOURCE_EXHAUSTED_JAVA_HEAP = 2,
    JVMTI_RESOURCE_EXHAUSTED_THREADS = 4,
}
